...
namespace CHAOS.Portal.Authentication.EmailPassword.Test
{
    public class EmailPasswordBaseTest : TestBase
    {
        ...
        public new void SetUp()
        {
            ...
            using (var db = new EmailPasswordEntities("metadata=res://*/Data.EmailPassword.csdl|res://*/Data.EmailPassword.ssdl|res://*/Data.EmailPassword.msl;provider=MySql.Data.MySqlClient;provider connection string=\"server=10.211.55.9;User Id=Portal;password=GECKONpbvu7000;Persist Security Info=True;database=EmailPassword\""))
            {
				db.PreTest();
