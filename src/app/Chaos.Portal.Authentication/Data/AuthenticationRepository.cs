namespace Chaos.Portal.Authentication.Data
{
  ...
  public class AuthenticationRepository : IAuthenticationRepository
  {
    ...
    public FacebookUser FacebookUserGet(ulong? facebookId = null, Guid? userId = null)
    {
      if(!facebookId.HasValue && !userId.HasValue)
        throw new ArgumentException("Both facebookId and userId cannot be null");
