...
namespace Chaos.Portal.Authentication
{
    ...
    public class AuthenticationModule : IAuthenticationModule
    {
        ...
        public void Load(IPortalApplication portalApplication)
        {
            ...
            portalApplication.MapRoute("/v5/EmailPassword", () => new EmailPassword(PortalApplication, AuthenticationRepository, Settings.Password));
            portalApplication.MapRoute("/v5/SecureCookie", () => new SecureCookie(PortalApplication, AuthenticationRepository));

            portalApplication.MapRoute("/v6/EmailPassword", () => new EmailPassword(PortalApplication, AuthenticationRepository, Settings.Password));
            ...
            portalApplication.MapRoute("/v6/Wayf", () => new Extension.Wayf(PortalApplication, AuthenticationRepository, new WayfFilter("WayfFilter.json")));
